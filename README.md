...
| ⚙️ 모델 연결 | 백엔드 / 주소 / 모델 / 키 / temperature / thinking / 생성 후 / max_tokens. **이 노드가 직접 설정하는 것은 이것뿐입니다** |
...
다만 그런 백엔드에서는 언로드가 실제로 일어나지 않습니다 — 모델은 계속 올라가 있습니다.
